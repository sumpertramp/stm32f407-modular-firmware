# STM32 Basic Timer (TIM6) – Bare Metal Example
...
```
---
## Example Usage – LED Toggle

The `examples/` directory contains ready-to-use example source files demonstrating how to use the basic timer driver in a real application context.
